                    ...
                    <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', Auth::user()->name) }}" 
                                   class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white">
                        </div>
                        ...
                        <form method="POST" action="{{ route('profile.destroy') }}" class="mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="password" name="password" id="password" required
                                       class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-red-500 focus:ring-red-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white">
                            </div>
