...
<body class="bg-white">
    ...
    <section class="relative h-screen flex items-center justify-center bg-cover bg-center" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('assets/img/hero-bg.jpg') }}');">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            @if (Route::has('login'))
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-block px-8 py-4 bg-brand-green text-white text-lg font-semibold rounded-lg hover:opacity-90 transition-all transform hover:scale-105">
                        Go to Dashboard
                    </a>
                @else
